...
describe('transfer funds to accounts', function () {
  test('should transfer funds successfully', function (done) {
    request(app(mockAccounts, mockUsers))
      ...
      .send({amount: 5000, userId: "TtR_nNEJCroj80fSOiec5", recepientAccountId: "F8n-xMpAB2GpYD4u9u6Z9"})
      .expect(201)
      .then(function (res) {
  ...
  test('throw error if balance is insufficient', function (done) {
    request(app(mockAccounts, mockUsers))
      .post('/accounts/transfer')
      .send({amount: 500000, userId: "TtR_nNEJCroj80fSOiec5", recepientAccountId: "F8n-xMpAB2GpYD4u9u6Z9"})
      .expect(400)
      .then(function (res) {
  ...
  test('throw error if sender account not found', function (done) {
    request(app(mockAccounts, mockUsers))
      .post('/accounts/transfer')
      .send({amount: 5000, userId: "sasanNEJCroj80fSOiec", recepientAccountId: "F8n-xMpAB2GpYD4u9u6Z9"})
      .expect(404)
      .then(function (res) {
  ...
  test('throw error if receipent account not found', function (done) {
    request(app(mockAccounts, mockUsers))
      .post('/accounts/transfer')
      .send({amount: 5000, userId: "TtR_nNEJCroj80fSOiec5", recepientAccountId: "MpAB2GpYD4u9u6Z"})
      .expect(404)
      .then(function (res) {
